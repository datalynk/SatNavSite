...
<html lang="en">
  ...
  <div class="contact-instruction contact-info">
    
    <?php if(!isset($error_message)){ ?>
      
        <h3 class="white">Please contact us with any queries on your booking</h3>
  ...
  <div class="col-lg-6 col-lg-offset-3">
    <form method="post" action="contact.php">
      <fieldset>
        ...
        <p>If you're a genuine human, please leave address field BLANK!</p>
        </div>
